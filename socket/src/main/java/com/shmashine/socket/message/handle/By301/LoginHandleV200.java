...
@Slf4j
@Component
public class LoginHandleV200 implements LoginHandle {
    ...
    private final ExecutorService executorService = new ShmashineThreadPoolExecutor(2, 8,
            ...
            PersistentRejectedExecutionHandler.of("executorService"), "LoginHandleV200");
    ...
    @Autowired
    public LoginHandleV200(ElevatorStatusHandle elevatorStatusHandle, TblDeviceService deviceService,
    ...
    public void deviceInfoHandle(MessageData messageData, Channel channel) {
        ...
        try {
            ...
            log.error("{} --- 更新设备信息失败 --- {}_{} --- {}", TimeUtils.nowTime(),
                    sensorType, elevatorCode, messageData, ExceptionUtils.getStackTrace(e));
        }
    }
