 ...
 */
@Component
public class SingleBoxNettyServerInitialize extends ChannelInitializer<SocketChannel> {

    private final SingleBoxNettyServerHandle escalatorNettyServerHandle;

    @Autowired
    public SingleBoxNettyServerInitialize(SingleBoxNettyServerHandle escalatorNettyServerHandle) {
