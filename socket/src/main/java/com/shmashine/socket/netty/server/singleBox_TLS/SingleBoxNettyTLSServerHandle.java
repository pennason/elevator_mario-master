 ...
 *
 * @author jiangheng
 * @version V1.0 -  2021/4/9 11:16
 */
@Slf4j
@Component
@ChannelHandler.Sharable
public class SingleBoxNettyTLSServerHandle extends SimpleChannelInboundHandler<String> {
    ...
    @Autowired
    public SingleBoxNettyTLSServerHandle(MessageHandle messageHandle, ElevatorStatusHandle elevatorStatusHandle) {
