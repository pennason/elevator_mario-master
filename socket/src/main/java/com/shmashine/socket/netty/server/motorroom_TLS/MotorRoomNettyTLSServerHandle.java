...
public class MotorRoomNettyTLSServerHandle extends SimpleChannelInboundHandler<String> {
    ...
    @Autowired
    public MotorRoomNettyTLSServerHandle(MessageHandle messageHandle, ElevatorStatusHandle elevatorStatusHandle) {
