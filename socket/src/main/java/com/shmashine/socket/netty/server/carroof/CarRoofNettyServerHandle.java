...
public class CarRoofNettyServerHandle extends SimpleChannelInboundHandler<String> {
    ...
    @Autowired
    public CarRoofNettyServerHandle(MessageHandle messageHandle, ElevatorStatusHandle elevatorStatusHandle) {
