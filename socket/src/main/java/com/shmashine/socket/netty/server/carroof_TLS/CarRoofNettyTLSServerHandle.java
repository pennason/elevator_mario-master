...
public class CarRoofNettyTLSServerHandle extends SimpleChannelInboundHandler<String> {
    ...
    @Autowired
    public CarRoofNettyTLSServerHandle(MessageHandle messageHandle, ElevatorStatusHandle elevatorStatusHandle) {
    ...
    public void handlerAdded(ChannelHandlerContext context) {
        ...
        channel.writeAndFlush(SocketConstants.CAR_ROOF_NEED_LOGIN);
    }
    ...
    protected void channelRead0(ChannelHandlerContext context, String message) {
        Channel channel = context.channel();
        // 消息处理
        boolean isLogin = messageHandle.messageHandle(message, SocketConstants.SENSOR_TYPE_CAR_ROOF, channel);
        if (!isLogin) {
