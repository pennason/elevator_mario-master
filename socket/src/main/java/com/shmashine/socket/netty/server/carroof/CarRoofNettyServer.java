...
@Slf4j
@Component
public class CarRoofNettyServer {
    ...
    @Value("${netty.car_roof.port}")
    private Integer port;

    private final CarRoofNettyServerInitializer carRoofNettyServerInitializer;

    @Autowired
    public CarRoofNettyServer(CarRoofNettyServerInitializer carRoofNettyServerInitializer) {
