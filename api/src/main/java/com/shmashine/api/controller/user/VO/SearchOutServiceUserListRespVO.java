 ...
 * @Author: jiangheng
 * @Version: 1.0.0
 * @Date: 2024/5/21 17:33
 * @Since: 1.0.0
 */
@Data
@SensitiveData
public class SearchOutServiceUserListRespVO {
    ...
    private String dtOpsCertExpire;

    @JsonProperty("vCompanyId")
    private String vCompanyId;

    @JsonProperty("vCompanyName")
    private String vCompanyName;

    @JsonProperty("vIdentity")
    @FieldEncrypt(key = "vIdentity")
    private String vIdentity;

    @JsonProperty("vOpsCertAgency")
    private String vOpsCertAgency;

    @JsonProperty("vOpsCertCode")
