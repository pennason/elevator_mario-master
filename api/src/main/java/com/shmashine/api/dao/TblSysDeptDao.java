...
public interface TblSysDeptDao {
    ...
    TblSysDept getByTypeAndName(@Param("deptTypeId") Integer deptTypeId, @Param("deptName") String deptName);

    int existsByName(String vDeptName);

    TblSysDept findByName(@NotNull @Param("vDeptName") String vDeptName, @Param("vParentId") String vParentId);
}