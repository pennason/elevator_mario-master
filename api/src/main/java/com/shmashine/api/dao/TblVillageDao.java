...
public interface TblVillageDao {
    ...
    TblVillage getById(@NotNull String vVillageId);
    ...
    TblVillage getVillageByProjectIdAndVillageName(@Param("projectId") String projectId, @Param("villageName") String villageName);
}