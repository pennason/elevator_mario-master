...
public interface BizDeptService {
     ...
     * 查询部门列表下级
     */
    List<TblSysDept> searchDeptParent(SearchDetpListModule searchDetpListModule);
     ...
     * @return
     */
    List<TblSysDept> getAll(SearchDetpListModule searchDetpListModule);
     ...
     * @return
     */
    Boolean geneOutServiceData(List<List<String>> data) throws Exception;
}
