package com.shmashine.api.module.elevatorProject.output;
...
/**
 * @PackgeName: com.shmashine.api.module.elevatorProject.output.ResultProjectDetail
 * @ClassName: ResultProjectDetail
 * @Date: 2020/7/618:57
 * @Author: LiuLiFu
 * @Description: 项目查看返回类
 */
public class ResultProjectDetail {
    /**
     * 项目id
     */
    ...
    public void setVDeptName(String vDeptIdName) {
        this.vDeptName = vDeptIdName;
    }
