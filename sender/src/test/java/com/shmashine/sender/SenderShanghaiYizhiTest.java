...
@DisplayName("上海翼智测试")
@SpringBootTest
public class SenderShanghaiYizhiTest {
    @Autowired
    CityTool cityTool;
    @Autowired
    ...
    public void testSendFault() {
        var message = "{\"faultName\":\"开门走车\",\"elevatorCode\":\"MX5231\",\"ST\":\"add\","
                + "\"uncivilizedBehaviorFlag\":0,\"D\":\"Ze+sZAEQAAH9AAABAwAAAAABAB4AAGE=\",\"TY\":\"Fault\","
                + "\"sensorType\":\"SINGLEBOX\",\"fault_type\":5,\"faultId\":\"8366816331685494784\","
                + "\"time\":\"2023-07-11 02:44:34\"}";
