...
public class ChongqingSender implements MonitorSend, TrappedSend, FaultSend, OnOfflineSend, PeriodicSend {
    private final CityTool cityTool;
    private final FaultResendTool faultResendTool;
    private final MessageCache messageCache;

    private static final String PT_CODE = "chongqing";
