...
public class NanjingSender implements MonitorSend, TrappedSend, FaultSend, OnOfflineSend, PeriodicSend {
    private final CityTool cityTool;
    private final MessageCache messageCache;

    private static final String PT_CODE = "nanjing";
