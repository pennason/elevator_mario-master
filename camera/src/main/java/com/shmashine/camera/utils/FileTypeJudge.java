...
import com.shmashine.camera.constants.FileType;
...
public final class FileTypeJudge {
    ...
    public static Integer isFileType(FileType value) {
        ...
        FileType[] videos = {FileType.AVI, FileType.RAM, FileType.RM, FileType.MPG, FileType.MOV, FileType.ASF, FileType.MP4, FileType.MP4_1, FileType.MP4_2, FileType.MP4_3, FileType.FLV, FileType.MID};
