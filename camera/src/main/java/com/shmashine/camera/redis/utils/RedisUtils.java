package com.shmashine.camera.redis.utils;
...
public class RedisUtils {
     ...
     * @return
     */
    public Set<String> getRangeByScore(String key, long startTime, long endTime) {
        return stringRedisTemplate.opsForZSet().rangeByScore(key, startTime, endTime);
    }

    /**
     * 根据指定的key—value移除对应的zSet值
     *
     * @param key
     * @param value
     * @param <T>
     */
    public <T> void zRemove(String key, T value) {
     ...
     * @return
     */
    public <T> Double getScore(String key, T value) {
