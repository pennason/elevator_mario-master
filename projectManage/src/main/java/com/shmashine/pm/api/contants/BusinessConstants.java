package com.shmashine.pm.api.contants;
...
public class BusinessConstants {
     ...
     * 小区状态
     */
    public static final Integer InvestigateLess = 1; // 待现勘

    public static final Integer DistributeLess = 2; // 待配货

    public static final Integer InstallLess = 3; // 待安装

    public static final Integer TestLess = 4; //待调试

    public static final Integer CheckLess = 5; //待验收

    public static final Integer Runing = 6; // 运行中

    public static final Integer Collocation = 7; //托管
}
