...
public class TblInvestigateOnceBill implements Serializable {
    ...
    // 有机房数量
    private Integer iMachRoomY;
    // 无机房数量
    private Integer iMachRoomN;
    // 有贯通门电梯数量
    private Integer iStraightDoorElevatorY;
    // 无贯通门电梯数量
    private Integer iStraightDoorElevatorN;
    // 其它特殊情况说明
    ...
    @JsonProperty("iMachRoomY")
    public Integer getiMachRoomY() {
        return iMachRoomY;
    }

    public void setiMachRoomY(Integer iMachRoomY) {
        this.iMachRoomY = iMachRoomY;
    }

    @JsonProperty("iMachRoomN")
    public Integer getiMachRoomN() {
        return iMachRoomN;
    }

    public void setiMachRoomN(Integer iMachRoomN) {
        this.iMachRoomN = iMachRoomN;
    }

    @JsonProperty("iStraightDoorElevatorY")
    public Integer getiStraightDoorElevatorY() {
        return iStraightDoorElevatorY;
    }

    public void setiStraightDoorElevatorY(Integer iStraightDoorElevatorY) {
        this.iStraightDoorElevatorY = iStraightDoorElevatorY;
    }

    @JsonProperty("iStraightDoorElevatorN")
    public Integer getiStraightDoorElevatorN() {
        return iStraightDoorElevatorN;
    }

    public void setiStraightDoorElevatorN(Integer iStraightDoorElevatorN) {
        this.iStraightDoorElevatorN = iStraightDoorElevatorN;
    }
    ...
    public String toString() {
        return "TblInvestigateOnceBill{" +
                "vInvestigateOnceBillId='" + vInvestigateOnceBillId + '\'' +
                ", vInvestigateTaskId='" + vInvestigateTaskId + '\'' +
                ", iWellHoleFourMeter=" + iWellHoleFourMeter +
                ", iMachRoom220=" + iMachRoom220 +
                ", iBackupCable=" + iBackupCable +
                ", iStraightDoorElevator=" + iStraightDoorElevator +
                ", vRealInvestigator='" + vRealInvestigator + '\'' +
                ", vRealInvestigatorPhone='" + vRealInvestigatorPhone + '\'' +
                ...
                ", vDevicePosition='" + vDevicePosition + '\'' +
                ", vElevatorBrand='" + vElevatorBrand + '\'' +
                ", iMachRoomY=" + iMachRoomY +
                ", iMachRoomN=" + iMachRoomN +
                ", iStraightDoorElevatorY=" + iStraightDoorElevatorY +
                ", iStraightDoorElevatorN=" + iStraightDoorElevatorN +
                ", greenCodeImages=" + greenCodeImages +
                ", floorImages=" + floorImages +
                ", machRoomSignalImages=" + machRoomSignalImages +
                ", equipmentCodeImages=" + equipmentCodeImages +
                ", elevatorDoorBtnInsideImages=" + elevatorDoorBtnInsideImages +
                ", images=" + images +
                '}';
    }
}
