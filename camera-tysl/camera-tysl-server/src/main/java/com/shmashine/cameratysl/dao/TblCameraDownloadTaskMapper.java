...
public interface TblCameraDownloadTaskMapper {
     ...
     * @return 受影响的行数
     */
    Integer updateFileStatusByCloudTaskId(@Param("entity") TblCameraDownloadTaskEntity entity);
    ...
    /**
     * 根据云端任务ID自增 RequestFailedCount 字段
     *
     * @param cloudTaskId 云端任务ID
     * @return 受影响的行数
     */
    Integer increaseRequestFailedCountByCloudTaskId(@Param("cloudTaskId") String cloudTaskId);
    ...
    List<TblCameraDownloadTaskEntity> getByFileStatus(@Param("fileStatusList") List<Integer> fileStatusList,
                                                      ...
                                                      @Param("exceptReturnCodes") List<Integer> exceptReturnCodes);
     ...
     * @return 文件地址列表
     */
    List<String> getDownloadSuccessfulLocalFile();
