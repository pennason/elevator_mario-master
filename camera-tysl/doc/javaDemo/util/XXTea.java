...
public class XXTea {
    ...
    public static String decrypt(String cipherHex, String charset, String hexKey) throws Exception {
        ...
        String cipher = new String(ByteFormat.hexToBytes(cipherHex));
        String hexKeystr = new String(ByteFormat.hexToBytes(hexKey));
        byte[] line = decrypt(ByteFormat.hexToBytes(cipherHex), ByteFormat.hexToBytes(hexKey));
