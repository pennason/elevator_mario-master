package com.shmashine.fault.camera.entity;
...
public class TblCamera implements Serializable {
    private static final long serialVersionUID = 191376860322379863L;
    ...
    public Integer getPushTrappedPeopleVoice() {
        return pushTrappedPeopleVoice;
    }

    public void setPushTrappedPeopleVoice(Integer pushTrappedPeopleVoice) {
        this.pushTrappedPeopleVoice = pushTrappedPeopleVoice;
    }
    ...
    public String toString() {
        return "TblCamera{" +
                ...
                ", iCameraType=" + iCameraType +
                ", vSerialNumber='" + vSerialNumber + '\'' +
                ", vUsername='" + vUsername + '\'' +
                ", vPassword='" + vPassword + '\'' +
                ", vCloudNumber='" + vCloudNumber + '\'' +
                ", vHlsUrl='" + vHlsUrl + '\'' +
                ", vRtmpUrl='" + vRtmpUrl + '\'' +
                ", vPrivateUrl='" + vPrivateUrl + '\'' +
                ", pushTrappedPeopleVoice=" + pushTrappedPeopleVoice +
