...
public class RedisConstants {
     ...
     * 楼层停靠统计配置标记
     */
    public static final String ELEVATOR_FLOOR_COUNT_MARK = "ELEVATOR:FLOOR:COUNT:MARK:";

    /**
     * 楼层热力图统计缓存
     */
    public static final String ELEVATOR_COUNT_HEARTMAP = "elevator:countheat:";
     ...
     * 上海仪电平台token缓存key
     */
    public static final String SH_YIDIAN_PLATFORM_TOKEN = "YIDIAN:PLATFORM:PLATFORM:TOKEN";


    /**
     * 麦信物业小程序电梯收藏
     */
    public static final String MAIXIN_WUYE_MINI_PROGRAM_USER_COLLECTION_ELEVATOR = "MAIXIN:WUYE:MINI_PROGRAM:USER_COLLECTION:ELEVATOR:";
