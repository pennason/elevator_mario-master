...
public class CryptoUtil {
    ...
    public static String encryptAesBase64(String key, String content) {
        ...
        try {
            ...
            log.error("加密错误已返回原值", ExceptionUtils.getStackTrace(e));
            return content;
        }
    ...
    public static String encryptMd5Base64(String content) {
        ...
        try {
            ...
            log.error("加密错误已返回原值-content:{}", content);
            return content;
        }
    ...
    public static String decryptAesBase64(String key, String content) {
        ...
        try {
            ...
            log.error("解密错误已返回原值-content:{}", content);
            return content;
        }
    }
    ...
    private static byte[] encryptAes(byte[] key, byte[] content) throws NoSuchPaddingException,
    ...
    private static byte[] decryptAes(String key, byte[] content) throws NoSuchPaddingException,
            NoSuchAlgorithmException, InvalidKeyException, BadPaddingException, IllegalBlockSizeException {
