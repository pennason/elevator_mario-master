...
import com.shmashine.common.utils.ReflectionKit;
 ...
 * @Since: 1.0.0
 */
public abstract class PrivacyAbstractHandler<T extends Annotation> {


    private final Class<T> annotationClass;

    public PrivacyAbstractHandler(Class<T> annotationClass) {
