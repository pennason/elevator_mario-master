...
/**
 * 用户收藏电梯表(TblElevatorCollect)实体类
 *
 * @author makejava
 * @since 2020-07-01 14:30:19
 */
public class TblElevatorCollect implements Serializable {
    @Serial
    private static final long serialVersionUID = -61193749303385911L;
    /**
     * 用户id
     */
