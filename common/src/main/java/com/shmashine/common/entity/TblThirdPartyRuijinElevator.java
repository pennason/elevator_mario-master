...
/**
 * (TblThirdPartyRuijinElevator)实体类
 *
 * @author makejava
...
@NoArgsConstructor
@ToString
public class TblThirdPartyRuijinElevator implements Serializable {
    @Serial
    private static final long serialVersionUID = -66758779717472882L;
