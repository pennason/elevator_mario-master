...
/**
 * 部门角色表(TblSysDeptRole)实体类
 *
 * @author liulifu
 * @since 2020-05-21 14:40:40
 */
public class TblSysDeptRole implements Serializable {
    private static final long serialVersionUID = -19160361983402316L;
    /**
     * 部门编号
     */
