 ...
 *
 * @author little.li
 * @since 2020-07-02 10:59:25
 */
public class TblSensor implements Serializable {

    @Serial
    private static final long serialVersionUID = -23165317098111479L;
    /**
     * 传感器id
     */
