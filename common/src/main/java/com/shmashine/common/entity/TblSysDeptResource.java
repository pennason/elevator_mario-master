...
/**
 * 部门电梯数据表（部门主档数据表）(TblSysDeptResource)实体类
 *
 * @author liulifu
 * @since 2020-05-21 14:39:36
 */

public class TblSysDeptResource implements Serializable {
    @Serial
    private static final long serialVersionUID = 381241738801757758L;
